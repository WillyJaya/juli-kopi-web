    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                echo "<div class='alert alert-success mt-3'>Terima kasih, <strong>$nama</strong>. Pesan Anda sudah dikirim!</div>";

                // Tambahkan logika simpan ke database atau kirim email di sini jika perlu.
            }
            ?>
        </div>
    </div>
